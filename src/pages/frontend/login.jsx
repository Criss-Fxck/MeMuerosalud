...
function Login() {
  ...
  return (
    <>
                      ...
                      <div className="p-5">
                        ...
                        <form onSubmit={handleSubmit(sendDataForm)} className="user">
                          <div className="form-group">
                            <input type="text" {...register("name", { required: true })} className="form-control form-control-user" id="usuarioForm" placeholder="Enter User..." />
                            <span className='text-danger'>{errors.name && "El usuario es obligatorio"}</span>
                          </div>
                          <div className="form-group">
                            <input type="password" {...register("password", { required: true })} className="form-control form-control-user" id="contraForm" placeholder="Password" />
      ...
      {dataform && <LoginData datalogin={dataform} />}
    </>
  );
}
